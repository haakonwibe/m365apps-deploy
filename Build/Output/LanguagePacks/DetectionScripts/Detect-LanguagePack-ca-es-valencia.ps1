...
<#
.SYNOPSIS
    Intune Win32 detection wrapper for the Microsoft 365 Apps Language Pack (ca-es-valencia).
...
.DESCRIPTION
    ...
    (e.g. VisioProRetail - ca-es-valencia) instead of the LanguagePack pseudo-
    product, edit the $TargetProduct value below.

    Upload this file directly as the custom detection script for the
    Intune Win32 app deploying ca-es-valencia.
