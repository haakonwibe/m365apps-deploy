...
| Field | Value |
|-------|-------|
| Install command   | `powershell.exe -NoProfile -ExecutionPolicy Bypass -File Install-Visio.ps1` |
| Uninstall command | `powershell.exe -NoProfile -ExecutionPolicy Bypass -File Uninstall-Visio.ps1` |
...
- Script: `DetectionScripts\Detect-Visio.ps1` (in this product folder; upload the exact file)
